...
public class BinaryTreeTest {
    ...
    public void testPreOrder() {
        ...
        assertEquals("Should inform the user the tree is empty and return null", null, testBinaryTree.preOrder());
        ...
        assertEquals("Should be [10, 7, 3, 18, 100, 5]", testList, testBinaryTree.preOrder());
    }
